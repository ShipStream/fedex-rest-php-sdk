...
namespace ShipStream\FedEx\PostalCodeValidationV1\Requests;
...
use ShipStream\FedEx\PostalCodeValidationV1\Responses\CountryCxsResponseVo;
use ShipStream\FedEx\PostalCodeValidationV1\Responses\ErrorResponseVo;
use ShipStream\FedEx\PostalCodeValidationV1\Responses\ErrorResponseVo401;
use ShipStream\FedEx\PostalCodeValidationV1\Responses\ErrorResponseVo403;
use ShipStream\FedEx\PostalCodeValidationV1\Responses\ErrorResponseVo404;
use ShipStream\FedEx\PostalCodeValidationV1\Responses\ErrorResponseVo500;
use ShipStream\FedEx\PostalCodeValidationV1\Responses\ErrorResponseVo503;
