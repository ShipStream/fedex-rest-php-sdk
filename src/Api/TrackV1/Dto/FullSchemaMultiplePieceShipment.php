...
final class FullSchemaMultiplePieceShipment extends Dto
{
     ...
     * @param  ?PagingDetails2  $pagingDetails  Specify the details about how to retrieve the subsequent pages when there is more than one page in the TrackReply.
     */
    public function __construct(
        ...
        public readonly ?PagingDetails2 $pagingDetails = null,
    ) {
    }
}
