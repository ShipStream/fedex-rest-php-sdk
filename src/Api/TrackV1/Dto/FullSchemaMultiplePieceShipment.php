...
{
    /**
     * @param  mixed[]  $masterTrackingNumberInfo  The detailed master tracking details for the shipment to be tracked.
     ...
     * @param  ?mixed[]  $pagingDetails  The details about how to retrieve the subsequent pages when there is more than one page in the TrackReply.
     */
    public function __construct(
        public readonly array $masterTrackingNumberInfo,
        public readonly string $associatedType,
        public readonly ?bool $includeDetailedScans = null,
        public readonly ?array $pagingDetails = null,
    ) {
    }
}
