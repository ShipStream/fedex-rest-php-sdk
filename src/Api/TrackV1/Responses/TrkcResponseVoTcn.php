...
use ShipStream\FedEx\Api\TrackV1\Dto\TrackingNumbersResponseTcn;
use ShipStream\FedEx\Response;

final class TrkcResponseVoTcn extends Response
{
    /**
     ...
     * @param  ?TrackingNumbersResponseTcn  $output  The response elements for the Track by TCN request.
     */
    public function __construct(
        public readonly ?string $transactionId = null,
        public readonly ?string $customerTransactionId = null,
        public readonly ?TrackingNumbersResponseTcn $output = null,
    ) {
    }
}
