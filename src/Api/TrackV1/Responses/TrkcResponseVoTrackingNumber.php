...
use ShipStream\FedEx\Api\TrackV1\Dto\TrackingNumbersResponse;
use ShipStream\FedEx\Response;

final class TrkcResponseVoTrackingNumber extends Response
{
    /**
     ...
     * @param  ?TrackingNumbersResponse  $output  The response elements for Tracking by tracking number request
     */
    public function __construct(
        public readonly ?string $transactionId = null,
        public readonly ?string $customerTransactionId = null,
        public readonly ?TrackingNumbersResponse $output = null,
    ) {
    }
}
