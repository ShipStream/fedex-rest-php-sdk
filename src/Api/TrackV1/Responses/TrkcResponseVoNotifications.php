...
use ShipStream\FedEx\Api\TrackV1\Dto\SendNotificationOutputVo;
use ShipStream\FedEx\Response;

final class TrkcResponseVoNotifications extends Response
{
    /**
     ...
     * @param  ?SendNotificationOutputVo  $output
     */
    public function __construct(
        public readonly ?string $transactionId = null,
        public readonly ?string $customerTransactionId = null,
        public readonly ?SendNotificationOutputVo $output = null,
    ) {
    }
}
