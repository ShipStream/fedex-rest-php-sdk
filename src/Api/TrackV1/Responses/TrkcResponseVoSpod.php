...
use ShipStream\FedEx\Api\TrackV1\Dto\SpodResponseVo;
use ShipStream\FedEx\Response;

final class TrkcResponseVoSpod extends Response
{
    /**
     ...
     * @param  ?SpodResponseVo  $output
     */
    public function __construct(
        public readonly ?string $transactionId = null,
        public readonly ?string $customerTransactionId = null,
        public readonly ?SpodResponseVo $output = null,
    ) {
    }
}
