...
use ShipStream\FedEx\Api\TrackV1\Dto\TrackingMpsResponse;
use ShipStream\FedEx\Response;

final class TrkcResponseVoAssociated extends Response
{
    /**
     ...
     * @param  ?TrackingMpsResponse  $output  The response elements for Tracking by Associated Shipment request.
     */
