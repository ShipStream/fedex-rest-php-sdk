...
use ShipStream\FedEx\Api\TrackV1\Dto\TrackingReferencesResponse;
use ShipStream\FedEx\Response;

final class TrkcResponseVoReferenceNumber extends Response
{
    /**
     ...
     * @param  ?TrackingReferencesResponse  $output  Specifies the response elements for Track by alternate reference request.
     */
