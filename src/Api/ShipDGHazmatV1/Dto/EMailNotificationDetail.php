...
final class EMailNotificationDetail extends Dto
{
    ...
    /**
     * @param  ?string  $aggregationType  Shipment Notification Aggregation Type.
     * @param  EmailNotificationRecipient[]|null  $emailNotificationRecipients  Provide Email Notification Recipient details.
