...
final class CompletedHazardousPackageDetail extends Dto
{
    ...
    /**
     * @param  ?string  $regulation  Specifies regulation type.<br>Example: IATA
     * @param  ?string  $accessibility  Specifies the accessibility.<br>Example: ACCESSIBLE
     * @param  ?string  $labelType  Specifies the label type.<br>Example: II_YELLOW
