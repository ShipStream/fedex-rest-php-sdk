...
final class Payment extends Dto
{
     ...
     * @param  ?Payor  $payor  Information about the person who is paying for the shipment. <br>Payor is mandatory when the paymentType is RECIPIENT, THIRD_PARTY or COLLECT.
     */
