...
final class VariableHandlingChargeDetail extends Dto
{
     ...
     * @param  ?float  $percentValue  This is the variable handling percentage. If the percent value is mentioned as 10, it means 10%(multiplier of 0.1).
     ...
     * @param  ?Money  $fixedValue  This is commodity value used for Customs declaration.
