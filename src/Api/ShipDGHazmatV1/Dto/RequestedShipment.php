...
final class RequestedShipment extends Dto
{
     ...
     * @param  ?Money  $totalDeclaredValue  This is commodity value used for Customs declaration.
     ...
     * @param  ?ShippingDocumentSpecification  $shippingDocumentSpecification  This field contains all data required for additional (non-label) shipping documents to be produced with a specific shipment.
