...
{
    protected static array $complexArrayTypes = ['commodities' => Commodity2::class, 'brokers' => BrokerDetail::class];
     ...
     * @param  Commodity2[]  $commodities  Indicates the details about the dutiable packages. Maximum upto 999 commodities per shipment
     ...
     * @param  ?RecipientCustomsId  $recipientCustomsId  Conditional
     *
     ...
     * @param  ?ExportDetail  $exportDetail  Conditional
     *                                       Export Detail Used for US or CA exports
     * @param  ?Money  $totalCustomsValue  This is commodity value used for Customs declaration.
     * @param  ?bool  $partiesToTransactionAreRelated  Parties To Transaction Are Related
     ...
     * @param  ?Money  $insuranceCharge  This is commodity value used for Customs declaration.
     */
