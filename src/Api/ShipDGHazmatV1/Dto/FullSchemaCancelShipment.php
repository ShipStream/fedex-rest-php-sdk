...
final class FullSchemaCancelShipment extends Dto
{
     ...
     * @param  ?string  $deletionControl  Specifies which packages in a shipment to be canceled.<br>  Valid Values are<br><b>DELETE_ALL_PACKAGES</b> which will cancel all tracking numbers associated to the shipment.
     */
