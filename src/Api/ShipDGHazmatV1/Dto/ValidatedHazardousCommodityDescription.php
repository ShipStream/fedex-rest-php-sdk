...
final class ValidatedHazardousCommodityDescription extends Dto
{
     ...
     * @param  ?string  $labelText  Specifies Hazard Label Text.<br>Example: labelText
     ...
     * @param  ?string  $authorization  Information related to quantity limitations and operator or state variations as may be applicable to the dangerous goods commodity.<br>Example: authorization
     ...
     * @param  ?string  $packingGroup  Specifies packing Group.<br>Example: Packing Group
     * @param  ?string  $properShippingName  Specifies Proper Shipping Name.<br>Example: Proper Shipping Name
