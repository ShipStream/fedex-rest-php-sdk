...
use ShipStream\FedEx\Api\ShipDGHazmatV1\Dto\CxsError5;
use ShipStream\FedEx\Response;

final class ErrorResponseVo6 extends Response
{
    protected static array $complexArrayTypes = ['errors' => CxsError5::class];
