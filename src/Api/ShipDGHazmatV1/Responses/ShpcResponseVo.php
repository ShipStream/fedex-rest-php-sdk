...
use ShipStream\FedEx\Api\ShipDGHazmatV1\Dto\BaseProcessOutputVo;
...
final class ShpcResponseVo extends Response
{
     ...
     * @param  ?BaseProcessOutputVo  $output  The response elements received when a shipment is created.
     */
