...
use ShipStream\FedEx\Api\ShipDGHazmatV1\Dto\CxsError4;
use ShipStream\FedEx\Response;

final class ErrorResponseVo5 extends Response
{
    protected static array $complexArrayTypes = ['errors' => CxsError4::class];
