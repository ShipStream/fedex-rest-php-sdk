...
namespace ShipStream\FedEx\Api\ShipDGHazmatV1\Responses;

use ShipStream\FedEx\Api\ShipDGHazmatV1\Dto\BaseProcessOutputVoCancelShipment;
...
final class ShpcResponseVoCancelShipment extends Response
{
     ...
     * @param  ?BaseProcessOutputVoCancelShipment  $output  The response elements received when a shipment is cancelled.
     */
    public function __construct(
        public readonly ?string $transactionId = null,
        public readonly ?string $customerTransactionId = null,
        public readonly ?BaseProcessOutputVoCancelShipment $output = null,
    ) {}
}
