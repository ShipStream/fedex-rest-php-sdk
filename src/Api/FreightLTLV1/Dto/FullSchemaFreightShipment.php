...
final class FullSchemaFreightShipment extends Dto
{
    ...
    /**
     * @param  FreightRequestedShipmentFreight2020  $freightRequestedShipment  The descriptive data for the FreightShipment being tendered to FedEx.
    ...
    public function __construct(
        public readonly FreightRequestedShipmentFreight2020 $freightRequestedShipment,
