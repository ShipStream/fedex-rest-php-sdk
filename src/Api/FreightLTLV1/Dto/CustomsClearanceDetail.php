...
final class CustomsClearanceDetail extends Dto
{
     ...
     * @param  BrokerDetail2[]|null  $brokers  Specify broker information. Use this option only if you are using Broker Select Option for your shipment. A country code must be specified in addition to one of the following address items: postal code, city, or location id.
     * @param  ?string  $freightOnValue  Specify the risk owner for the Freight shipment.
     * @param  ?Payment  $dutiesPayment  This is a payment type, basically indicates who is the payor for the shipment.Conditional required for International Shipments
     ...
     * @param  ?Party2  $importerOfRecord  Use this object to provide the attributes such as physical address, contact information and account number information.
    ...
    public function __construct(
        ...
        public readonly ?Party2 $importerOfRecord = null,
