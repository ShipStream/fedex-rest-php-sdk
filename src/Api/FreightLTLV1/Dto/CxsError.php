...
final class CxsError extends Dto
{
    ...
    /**
     * @param  ?string  $code  Indicates the error code.<br>Example: CRSVACCOUNT.NUMBER.INVALID,LOGIN.REAUTHENTICATE.ERROR,UNAUTHORIZED.USAGE,NOT.FOUND.ERROR,INTERNAL.SERVER.ERROR
