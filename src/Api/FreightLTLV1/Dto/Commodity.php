...
final class Commodity extends Dto
{
    ...
    /**
     * @param  Money2  $unitPrice  Specifies taxes or miscellaneous charge.
     ...
     * @param  ?Money2  $customsValue  Specifies taxes or miscellaneous charge.
    ...
    public function __construct(
        public readonly Money2 $unitPrice,
        public readonly int $quantity,
        public readonly string $quantityUnits,
        public readonly string $countryOfManufacture,
