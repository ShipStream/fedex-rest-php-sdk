...
{
    /**
     * @param  string  $pickupLocation  The descriptive data for the party responsible for the pickup and the physical location from which the shipment is picked up. <br>Note: This information is not required in case the pickupAddressType value is set to ACCOUNT.</br>
