...
final class CommercialInvoice extends Dto
{
     ...
     * @param  ?Money2  $taxesOrMiscellaneousCharge  Specifies taxes or miscellaneous charge.
     * @param  ?string  $taxesOrMiscellaneousChargeType  Indicate the type of taxes Or miscellaneous charge.
     * @param  ?Money2  $freightCharge  Specifies taxes or miscellaneous charge.
     * @param  ?Money2  $packingCosts  Specifies taxes or miscellaneous charge.
     * @param  ?Money2  $handlingCosts  Specifies taxes or miscellaneous charge.
    ...
    public function __construct(
        ...
        public readonly ?Money2 $taxesOrMiscellaneousCharge = null,
        public readonly ?string $taxesOrMiscellaneousChargeType = null,
        public readonly ?Money2 $freightCharge = null,
        public readonly ?Money2 $packingCosts = null,
        public readonly ?Money2 $handlingCosts = null,
