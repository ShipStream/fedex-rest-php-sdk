...
final class CompletedPackageDetail extends Dto
{
     ...
     * @param  ?Weight2  $dryIceWeight  These are the package weight details.<br>Note: Weight is not required for One rate shipments
    ...
    public function __construct(
        ...
        public readonly ?Weight2 $dryIceWeight = null,
