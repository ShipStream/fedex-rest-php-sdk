...
final class EmailNotificationRecipient extends Dto
{
     ...
     * @param  ?string  $locale  These are the locale details for email.<br><a onclick='loadDocReference("locales")'>click here to see Locales</a><br>Note: If the locale is left blank or an invalid local is entered, an invalid error message is returned in response
     * @param  ?string[]  $notificationEventType  Specify notification event types.<br><a onclick='loadDocReference("notificationeventtypes")'>Click here for more information on Notification Event Types.
     */
