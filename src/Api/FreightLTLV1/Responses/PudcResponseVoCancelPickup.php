...
use ShipStream\FedEx\Api\FreightLTLV1\Dto\CancelFreightPickupOutputVo;
...
final class PudcResponseVoCancelPickup extends Response
{
     ...
     * @param  ?CancelFreightPickupOutputVo  $output  The response elements received when you cancel a freight pickup.
     */
    public function __construct(
        public readonly ?string $transactionId = null,
        public readonly ?string $customerTransactionId = null,
        public readonly ?CancelFreightPickupOutputVo $output = null,
    ) {
    }
}
