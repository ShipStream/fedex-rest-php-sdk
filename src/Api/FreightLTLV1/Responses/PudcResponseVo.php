...
use ShipStream\FedEx\Api\FreightLTLV1\Dto\CreatePickupOutputVo;
use ShipStream\FedEx\Response;

final class PudcResponseVo extends Response
{
    /**
     ...
     * @param  ?CreatePickupOutputVo  $output  The response elements received when you create a Freight pickup.
     */
