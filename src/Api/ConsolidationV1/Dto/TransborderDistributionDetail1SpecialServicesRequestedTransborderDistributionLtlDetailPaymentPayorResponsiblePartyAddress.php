...
final class TransborderDistributionDetail1SpecialServicesRequestedTransborderDistributionLtlDetailPaymentPayorResponsiblePartyAddress extends Dto
{
    /**
     ...
     * @param  ?string  $countryCode  This is the Two-letter country code. <a onclick='loadDocReference("countrycodes")'>click here to see Country Codes</a>
