...
final class CompletedPackageDetail extends Dto
{
    ...
    /**
     * @param  ?int  $sequenceNumber  A positive integer specifying the sequence number for the package in shipment.
     * @param  ?PackageOperationalDetail  $operationalDetail  Package-level data required for labeling and/or movement.
     * @param  ?string  $signatureOption  This specifies the actual signature option applied, to allow for cases in which the value requested conflicted with other service features in the shipment.
     * @param  TrackingId[]|null  $trackingIds  The field is present to allow use of preassigned Master Airway Bill tracking number.
     * @param  ?int  $groupNumber  Used with request containing PACKAGE_GROUPS, to identify which group of identical packages was used to produce a reply item.
     * @param  ?string  $oversizeClass  Indicates the oversize Classification.
