...
use ShipStream\FedEx\Api\ConsolidationV1\Dto\ModifyConsolidationOutputVo;
use ShipStream\FedEx\Response;

final class ModifyConsolidationResponse extends Response
{
    /**
     ...
     * @param  ?ModifyConsolidationOutputVo  $output  This is the response received when a consolidation shipment is modified.
     */
