...
use ShipStream\FedEx\Api\ConsolidationV1\Dto\BaseProcessOutputVoConsolidationShipmentResults;
use ShipStream\FedEx\Response;

final class ConsolidationShipmentResultsResponse extends Response
{
    /**
     ...
     * @param  ?BaseProcessOutputVoConsolidationShipmentResults  $output
     */
    public function __construct(
        public readonly ?string $transactionId = null,
        public readonly ?string $customerTransactionId = null,
        public readonly ?BaseProcessOutputVoConsolidationShipmentResults $output = null,
    ) {
    }
}
