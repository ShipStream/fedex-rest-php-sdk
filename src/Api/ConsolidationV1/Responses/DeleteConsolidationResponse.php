...
use ShipStream\FedEx\Api\ConsolidationV1\Dto\DeleteConsolidationOutputVo;
use ShipStream\FedEx\Response;

final class DeleteConsolidationResponse extends Response
{
    /**
     ...
     * @param  ?DeleteConsolidationOutputVo  $output  This is the response received when a consolidation shipment is deleted.
     */
    public function __construct(
        public readonly ?string $customerTransactionId = null,
        public readonly ?string $transactionId = null,
        public readonly ?DeleteConsolidationOutputVo $output = null,
    ) {
    }
}
