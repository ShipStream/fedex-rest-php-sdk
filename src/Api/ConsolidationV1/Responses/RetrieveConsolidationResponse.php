...
use ShipStream\FedEx\Api\ConsolidationV1\Dto\BaseProcessOutputVoRetrieveConsolidation;
use ShipStream\FedEx\Response;

final class RetrieveConsolidationResponse extends Response
{
    /**
     ...
     * @param  ?BaseProcessOutputVoRetrieveConsolidation  $output  This is the response received when a consolidation shipment is retrieved.
     */
