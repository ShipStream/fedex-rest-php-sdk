...
use ShipStream\FedEx\Api\RatesAndTransitTimesV1\Responses\ErrorResponseVo401;
use ShipStream\FedEx\Api\RatesAndTransitTimesV1\Responses\ErrorResponseVo403;
use ShipStream\FedEx\Api\RatesAndTransitTimesV1\Responses\ErrorResponseVo404;
use ShipStream\FedEx\Api\RatesAndTransitTimesV1\Responses\ErrorResponseVo500;
use ShipStream\FedEx\Api\RatesAndTransitTimesV1\Responses\ErrorResponseVo503;
...
class RateAndTransitTimes extends Request implements HasBody
{
    ...
    public function createDtoFromResponse(
        Response $response,
    ): RatcResponseVo|ErrorResponseVo|ErrorResponseVo401|ErrorResponseVo403|ErrorResponseVo404|ErrorResponseVo500|ErrorResponseVo503 {
