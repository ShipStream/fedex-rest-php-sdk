...
final class OperationalDetail extends Dto
{
     ...
     * @param  ?string[]  $stateOrProvinceCodes  Specifies state Or Province Code. State code is required for US, CA, PR and not required for other countries. Conditional. Max length is 2. <br> Example: TN
