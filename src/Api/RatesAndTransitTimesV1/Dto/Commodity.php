...
final class Commodity extends Dto
{
     ...
     * @param  ?string  $countryOfManufacture  This is commodity country of manufacture. This is required. Maximum allowed length is 4. <br>Example: US<br><a onclick='loadDocReference("countrycodes")'>Click here to see Country Codes</a>
