...
{
    /**
     * @param  ?Money1  $codCollectionAmount  Indicate the amount details. This is optional, but if indicated, amount and currency must be provided.
    ...
    public function __construct(
        public readonly ?Money1 $codCollectionAmount = null,
