...
final class VariableHandlingChargeDetail extends Dto
{
     ...
     * @param  ?Money1  $fixedValue  Indicate the amount details. This is optional, but if indicated, amount and currency must be provided.
     */
    public function __construct(
        ...
        public readonly ?Money1 $fixedValue = null,
    ) {
    }
}
