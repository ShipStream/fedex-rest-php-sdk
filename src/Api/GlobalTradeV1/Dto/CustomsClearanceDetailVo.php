...
final class CustomsClearanceDetailVo extends Dto
{
     ...
     * @param  ?Money1  $insuranceCharges  Specify Insurance charges if applicable.<br><i>Note: FedEx does not provide insurance of any kind</i>.
     * @param  ?mixed[]  $importerOfRecordAccountNumber  The descriptive data for the importer of Record for the shipment and account number information.
    ...
    public function __construct(
        ...
        public readonly ?Money1 $insuranceCharges = null,
        public readonly ?array $importerOfRecordAccountNumber = null,
