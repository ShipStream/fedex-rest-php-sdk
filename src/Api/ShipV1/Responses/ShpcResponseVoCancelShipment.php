...
use ShipStream\FedEx\Api\ShipV1\Dto\CancelShipmentOutputVo;
use ShipStream\FedEx\Response;

final class ShpcResponseVoCancelShipment extends Response
{
    /**
     ...
     * @param  ?CancelShipmentOutputVo  $output  The response elements received when a shipment is cancelled.
     */
    public function __construct(
        public readonly ?string $transactionId = null,
        public readonly ?string $customerTransactionId = null,
        public readonly ?CancelShipmentOutputVo $output = null,
    ) {
    }
}
