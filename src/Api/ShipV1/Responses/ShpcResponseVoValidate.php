...
use ShipStream\FedEx\Api\ShipV1\Dto\VerifyShipmentOutputVo;
use ShipStream\FedEx\Response;

final class ShpcResponseVoValidate extends Response
{
    /**
     ...
     * @param  ?VerifyShipmentOutputVo  $output  The response elements received when a shipment is created.
     */
    public function __construct(
        public readonly ?string $transactionId = null,
        public readonly ?string $customerTransactionId = null,
        public readonly ?VerifyShipmentOutputVo $output = null,
    ) {
    }
}
