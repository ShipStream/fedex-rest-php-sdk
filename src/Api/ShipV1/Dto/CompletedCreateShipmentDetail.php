...
final class CompletedCreateShipmentDetail extends Dto
{
     ...
     * @param  ?string  $packagingDescription  Specifies packaging description<br>Example: Customer Packaging
     * @param  ?TrackingId  $masterTrackingId  Indicates the tracking details of the package.
     ...
     * @param  ?CreateShipmentRating  $shipmentRating  All shipment-level rating data for this shipment, which may include data for multiple rate types.
    ...
    public function __construct(
        ...
        public ?CreateShipmentRating $shipmentRating = null,
