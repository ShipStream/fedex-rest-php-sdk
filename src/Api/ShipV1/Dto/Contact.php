...
final class Contact extends Dto
{
     ...
     * @param  ?string  $companyName  Specify contact company name.<br>Note: Recommended Length is 35. There's no specific validation for the company name.<br>Example: FedEx
     */
