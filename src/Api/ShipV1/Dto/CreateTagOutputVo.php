...
final class CreateTagOutputVo extends Dto
{
     ...
     * @param  ?mixed[]  $completedTagDetail  Specifies the pickup confirmation and location details for the return tag shipment.
    ...
    public function __construct(
        ...
        public readonly ?array $completedTagDetail = null,
