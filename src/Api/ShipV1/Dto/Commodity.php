...
final class Commodity extends Dto
{
     ...
     * @param  ?mixed[]  $unitPrice  This is the unit price.
     ...
     * @param  ?mixed[]  $customsValue  This customs value is applicable for all items(or units) under the specified commodity.
    ...
    public function __construct(
        ...
        public readonly ?array $unitPrice = null,
