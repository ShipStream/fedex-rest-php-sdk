...
{
    /**
     * @param  PartyAccountNumber2  $accountNumber  The account number of the recipient.
    ...
    public function __construct(
        public readonly PartyAccountNumber2 $accountNumber,
        public readonly string $serviceType,
        public readonly CompletedTagDetail2 $completedTagDetail,
