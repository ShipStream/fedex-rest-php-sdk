...
final class RequestedPackageLineItem extends Dto
{
     ...
     * @param  ?int  $sequenceNumber  Optional. <br>Used only with individual packages as a unique identifier of each requested package. Will be adjusted at the shipment level as pieces are added.
