...
use ShipStream\FedEx\Api\ServiceAvailabilityV1\Dto\TransitTimeOutput;
use ShipStream\FedEx\Response;

final class TransitTimeOutputVo extends Response
{
    /**
     ...
     * @param  ?TransitTimeOutput  $output  This is the output response details for the services and transit time request.
     */
