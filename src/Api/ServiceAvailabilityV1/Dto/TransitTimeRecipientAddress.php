...
final class TransitTimeRecipientAddress extends Dto
{
    /**
     * @param  string  $postalCode  Identification of a region for mail/package delivery. Format and presence of this field will vary, depending on the country.Optional for non postal-aware countries. Max length is 10.<br> Example: 38127
     ...
     * @param  ?string  $city  The name of city, town, etc. <br>Example: Collierville
