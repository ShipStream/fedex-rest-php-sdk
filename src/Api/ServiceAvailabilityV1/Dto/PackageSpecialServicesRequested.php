...
final class PackageSpecialServicesRequested extends Dto
{
    ...
    /**
     * @param  string  $codDetail  For Ground-only COD, populate this object for COD detail information at the package level.
     ...
     * @param  ?string  $dryIceWeight  These are the weight details.
     */
    public function __construct(
        public readonly string $codDetail,
        ...
        public readonly ?string $dryIceWeight = null,
    ) {
    }
}
