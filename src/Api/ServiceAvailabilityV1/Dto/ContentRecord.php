...
{
    /**
     * @param  ?string  $itemNumber  This is a package item number.<br> Example: 45673289
     * @param  ?int  $receivedQuantity  This is the package item quantity.<br> Example: 2
     * @param  ?string  $description  This is the description of the package item.
     * @param  ?string  $partNumber  This is the part Number <br> Example: 123
     */
