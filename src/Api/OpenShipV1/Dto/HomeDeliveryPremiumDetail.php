...
{
    /**
     * @param  ?PhoneNumber1  $phoneNumber  Indicate the phone number. Only numeric values allowed.<br> Note that phoneNumber is mandatory when homedeliveryPremiumType is DATE_CERTAIN or EVENING.
    ...
    public function __construct(
        public readonly ?PhoneNumber1 $phoneNumber = null,
