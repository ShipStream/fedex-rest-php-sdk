...
final class HazardousCommodityDescription01 extends Dto
{
    /**
     ...
     * @param  ?HazardousCommodityPackingDetail01  $packingDetails  Specifies documentation and limits for validation of an individual packing group/category. DG Data Upload Mode: Required (IATA), Optional (Other), DG Full Validation Mode: Required (IATA), Optional (Other),
    ...
    public function __construct(
        ...
        public readonly ?HazardousCommodityPackingDetail01 $packingDetails = null,
