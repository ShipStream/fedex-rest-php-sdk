...
use ShipStream\FedEx\Api\OpenShipV1\Dto\ModifyPackageInOpenShipmentOutputVo;
use ShipStream\FedEx\Response;

final class ShpcResponseVoModifyPackageInOpenShipment extends Response
{
    /**
     ...
     * @param  ?ModifyPackageInOpenShipmentOutputVo  $output  The response elements received when a shipment is created.
     */
