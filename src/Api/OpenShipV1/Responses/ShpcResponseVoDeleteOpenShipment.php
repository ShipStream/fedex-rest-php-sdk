...
use ShipStream\FedEx\Api\OpenShipV1\Dto\DeleteOpenShipmentOutputVo;
use ShipStream\FedEx\Response;

final class ShpcResponseVoDeleteOpenShipment extends Response
{
    /**
     ...
     * @param  ?DeleteOpenShipmentOutputVo  $output  The response elements received when a shipment is created.
     */
    public function __construct(
        public readonly ?string $transactionId = null,
        public readonly ?string $customerTransactionId = null,
        public readonly ?DeleteOpenShipmentOutputVo $output = null,
    ) {
    }
}
