...
{
    /**
     * @param  ?string[]  $streetLines  This is a combination of number, street name, etc. <br>Note: At least one line is required. Empty lines should not be included. Minimum length is 3 and maximum length is 35.<br>Example: [\"10 FedEx Parkway\", \"Suite 302\"]
