...
{
    /**
     * @param  ?string  $serviceType  Specify the FedEx service type for the shipment.<br>Example: FEDEX_FREIGHT_PRIORITY
     * @param  ?Weight  $weight  These are the package weight details.
     * @param  ?string  $packagingType  Specify the FedEx Packaging Type for the shipment.
