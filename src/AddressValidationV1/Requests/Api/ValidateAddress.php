...
namespace ShipStream\FedEx\AddressValidationV1\Requests\Api;
...
use ShipStream\FedEx\AddressValidationV1\Responses\AdvcResponseVo;
use ShipStream\FedEx\AddressValidationV1\Responses\ErrorResponseVo;
use ShipStream\FedEx\AddressValidationV1\Responses\ErrorResponseVo401;
use ShipStream\FedEx\AddressValidationV1\Responses\ErrorResponseVo403;
use ShipStream\FedEx\AddressValidationV1\Responses\ErrorResponseVo404;
use ShipStream\FedEx\AddressValidationV1\Responses\ErrorResponseVo500;
use ShipStream\FedEx\AddressValidationV1\Responses\ErrorResponseVo503;
